...
distance = (posperso.x+posperso.w)-e->posscreen.x;
distance1 =(e->posscreen.x+e->posscreen.w)-posperso.x;
 
  if((distance<=400)&&((e->posscreen.x+e->posscreen.w)<posperso.x))
  {
     e->posscreen.x +=10;
      e->direction=0;
  ...
  else if ((distance1<400)&&((posperso.x+posperso.w)<e->posscreen.x))
  {
    e->posscreen.x -= 10 ;
    e->direction=1;  
